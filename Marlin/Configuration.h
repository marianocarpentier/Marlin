...
#define HOTEND_OFFSET_X {-41.05, 0.0} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {-1.47, 0.0}  // (in mm) for each extruder, offset of the hotend on the Y axis
